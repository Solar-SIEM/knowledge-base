...
Ниже — все восемь операций сценария: шесть работают с локальным хостом, две — с
Active Directory.
...
| 6 | Аудит администраторов домена и времени их последнего входа | Windows AD |
| 7 | Блокировка/разблокировка УЗ | Windows AD |
| 8 | Экстренный сброс пароля доменного пользователя | Windows AD |
...
### Операция 6. Аудит администраторов домена и времени их последнего входа
...
### Операция 7. Блокировка/разблокировка УЗ
...
### Операция 8. Экстренный сброс пароля доменного пользователя
